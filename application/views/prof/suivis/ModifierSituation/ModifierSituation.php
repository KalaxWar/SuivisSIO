...
echo form_open('etudiant/modifierUneSituation/');
...
echo '<div class="form-inline">';
  echo '<p><b>Date de début : <span class=oblig>*</span></b> <input type="text" name="txtdatedebut" id="datepicker1" class="form-control" required placeholder="Cliquez pour séléctioner" value='.$datedebut.'></p>';
  echo '<p><b>Date de fin : <span class=oblig>*</span> </b> <input type="text" name="txtdatefin" id="datepicker2" class="form-control" required placeholder="Cliquez pour séléctioner" value='.$datefin.'></p>';
echo '</div>';
...
<br><p align='center'><input type="submit" name="Envoyer" class="btn btn-outline-primary btn-sm" value="Modifier la situation"></p>
</div></div>
